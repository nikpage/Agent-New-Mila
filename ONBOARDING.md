...
- Environment variables set (see Vercel dashboard or `CLAUDE.md` Security section for required vars)
...
| `kc_low_value` | number | `500000` | "Small deal" anchor for log-scale priority scoring. Maps to normalized score ~2. |
| `kc_high_value` | number | `5000000` | "Big deal" anchor for log-scale priority scoring. Maps to normalized score ~13. Values above this extend to ~34 for outlier deals. |
