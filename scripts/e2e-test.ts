...
const TEST_EMAILS: TestEmail[] = [
  {
    ...
    body: [
      ...
      'We are considering options for the next few months and this caught our eye.',
      '',
  ...
  },
  {
    ...
    body: [
      ...
      '',
      'Can you confirm the financing is ready? We should get the bank documents',
      'sorted out sometime next week.',
      '',
      'Martin Kral',
    ].join('\n'),
  },
