...
export async function createHoldEvent(params: {
  ...
  return createEvent({
    ...
    title: `REZERVACE: Schůzka s ${params.cpName}`,
    description: `Předběžná rezervace — čeká se na potvrzení od ${params.cpName}. Spravuje Mila.`,
...
export async function createTravelBuffer(params: {
  ...
  return createEvent({
    ...
    title: `Cesta: ${params.fromLocation} → ${params.toLocation}`,
    description: `Časová rezerva na cestu (${params.travelDurationText}). Spravuje Mila.`,
