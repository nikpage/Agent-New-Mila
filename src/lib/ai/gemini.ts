...
The CP's explicit request IS the action. Do not substitute it with preparatory tasks. If CP says "potvrďte do 17:00" (confirm by 5pm), the action is CONFIRM — not "prepare documents." If a TODO exists alongside a SCHEDULE, the TODO should address what the user must do INDEPENDENTLY of the meeting — not restate what the meeting will cover.
